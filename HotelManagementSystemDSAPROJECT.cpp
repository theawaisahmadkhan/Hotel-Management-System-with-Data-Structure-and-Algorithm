...
case 1://operate standard room
		...
		cout<<"\t"<<"\t"<<"\t"<<"PRESS 0 FOR EXIT STANDARD TYPE ROOM:"<<endl;
		cin>>e;
...
p[0]->input(a,b,t_date,month,file1,file);	
	...
	case 2://use for a moderate type room
		...
		cout<<"\t"<<"\t"<<"\t"<<"PRESS 3 RESERVE ROOM DATA:"<<endl;
		cout<<"\t"<<"\t"<<"\t"<<"PRESS 4 FOR REMANING TIME OF RESERVED ROOM:"<<endl;
		cout<<"\t"<<"\t"<<"\t"<<"PRESS 0 FOR EXIT MODERATE TYPE ROOM:"<<endl;
		cin>>e;
		if(e==1)
		{
			cout<<"\t"<<"\t"<<"\t"<<"ENTER TIME IN HOUR AND IN MIN:"<<endl;
...
p[1]->output(file);					
	...
	case 3:
		...
		cout<<"\t"<<"\t"<<"\t"<<"PRESS 3 RESERVE ROOM DATA:"<<endl;
		cout<<"\t"<<"\t"<<"\t"<<"PRESS 4 FOR REMANING TIME OF RESERVED ROOM:"<<endl;
		cout<<"\t"<<"\t"<<"\t"<<"PRESS 0 FOR EXIT SUPERIOR TYPE ROOM:"<<endl;
		cin>>e;
		if(e==1)
		{
			cout<<"\t"<<"\t"<<"\t"<<"ENTER TIME IN HOUR AND IN MIN:"<<endl;
...
p[2]->output(file);						
	...
	case 4:
		...
		cout<<"\t"<<"\t"<<"\t"<<"PRESS 3 RESERVE ROOM DATA:"<<endl;
		cout<<"\t"<<"\t"<<"\t"<<"PRESS 4 FOR REMANING TIME OF RESERVED ROOM:"<<endl;
		cout<<"\t"<<"\t"<<"\t"<<"PRESS 0 FOR EXIT JUNIOR_SUITE TYPE ROOM:"<<endl;
		cin>>e;
		if(e==1)
		{
			cout<<"\t"<<"\t"<<"\t"<<"ENTER TIME IN HOUR AND IN MIN:"<<endl;
